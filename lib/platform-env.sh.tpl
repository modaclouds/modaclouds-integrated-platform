...
export MODACLOUDS_RABBITMQ_ENDPOINT_IP_HACK=$(get_public_address rabbitmq)
...
export MODACLOUDS_FUSEKI_ENDPOINT_IP_HACK=$(get_public_address fuseki)
...
export MODACLOUDS_TOWER4CLOUDS_DATA_ANALYZER_ENDPOINT_IP_PUBLIC=$(get_public_address t4c-dda)
...
export MODACLOUDS_TOWER4CLOUDS_MANAGER_ENDPOINT_IP_PUBLIC=$(get_public_address t4c-manager)
...
export MODACLOUDS_MODELS_AT_RUNTIME_ENDPOINT_IP_PUBLIC=$(get_public_address mrt)
